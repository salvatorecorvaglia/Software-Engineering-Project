...
@Component({
  ...
  templateUrl: './addphotoagent.page.html',
  styleUrls: ['./addphotoagent.page.scss'],
})
export class AddphotoagentPage implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
              ...
              // @ts-ignore
              private iab: InAppBrowser) {firebase.auth().onAuthStateChanged(user => {
    if (user) {
