...
public class Image implements Serializable {
    ...
    @Column(name="Url", nullable=false, length=18000000)
    private String url;
    @Column(name="Lat")
    private Double lat;
    @Column(name="Lon")
    private Double lon;
    @Column(name="IdFire", length=200)
    ...
    /**
     * Access method for idFire.
     *
     * @return the current value of idFire
     */
    ...
    /**
     * Setter method for idFire.
     *
     * @param aLong_ the new value for idFire
     */
    public void setIdFire(String aIdFire) {
        idFire = aIdFire;
    }
