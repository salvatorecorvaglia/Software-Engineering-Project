...
public class Intervention implements Serializable {
    ...
    @Column(name="FirstReport")
    private String firstReport;
    @Column(name="LastReport", length =18000000)
     ...
     *
     * @param aIdIntervention the new value for idIntervention
     */
    ...
    /**
     * Access method for firstReport.
     *
     * @return the current value of firstReport
     */
    ...
    /**
     * Setter method for firstReport.
     *
     * @param aFirstReport the new value for firstReport
     */
    public void setFirstReport(String aFirstReport) {
        firstReport = aFirstReport;
    }

    /**
     * Access method for lastReport.
     *
     * @return the current value of lastReport
     */
     ...
     *
     * @param aLastReport the new value for lastReport
     */
    public void setLastReport(String aLastReport) {
